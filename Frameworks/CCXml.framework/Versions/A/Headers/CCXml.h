...
#import "CCXmlDocument.h"



#if TARGET_OS_IPHONE && 0 // Disabled by default

// Since CCXml is a drop in replacement for NSXML,
// it may be desireable (when writing cross-platform code to be used on both Mac OS X and iOS)
// to use the NSXML prefixes instead of the CCXml prefix.
// 
// This way, on Mac OS X it uses NSXML, and on iOS it uses CCXml.

#ifndef NSXMLNode
  #define NSXMLNode CCXmlNode
#endif
#ifndef NSXMLElement
  #define NSXMLElement CCXmlElement
#endif
#ifndef NSXMLDocument
  #define NSXMLDocument CCXmlDocument
#endif

#ifndef NSXMLInvalidKind
  #define NSXMLInvalidKind CCXmlInvalidKind
#endif
#ifndef NSXMLDocumentKind
  #define NSXMLDocumentKind CCXmlDocumentKind
#endif
#ifndef NSXMLElementKind
  #define NSXMLElementKind CCXmlElementKind
#endif
#ifndef NSXMLAttributeKind
  #define NSXMLAttributeKind CCXmlAttributeKind
#endif
#ifndef NSXMLNamespaceKind
  #define NSXMLNamespaceKind CCXmlNamespaceKind
#endif
#ifndef NSXMLProcessingInstructionKind
  #define NSXMLProcessingInstructionKind CCXmlProcessingInstructionKind
#endif
#ifndef NSXMLCommentKind
  #define NSXMLCommentKind CCXmlCommentKind
#endif
#ifndef NSXMLTextKind
  #define NSXMLTextKind CCXmlTextKind
#endif
#ifndef NSXMLDTDKind
  #define NSXMLDTDKind CCXmlDTDKind
#endif
#ifndef NSXMLEntityDeclarationKind
  #define NSXMLEntityDeclarationKind CCXmlEntityDeclarationKind
#endif
#ifndef NSXMLAttributeDeclarationKind
  #define NSXMLAttributeDeclarationKind CCXmlAttributeDeclarationKind
#endif
#ifndef NSXMLElementDeclarationKind
  #define NSXMLElementDeclarationKind CCXmlElementDeclarationKind
#endif
#ifndef NSXMLNotationDeclarationKind
  #define NSXMLNotationDeclarationKind CCXmlNotationDeclarationKind
#endif

#ifndef NSXMLNodeOptionsNone
  #define NSXMLNodeOptionsNone CCXmlNodeOptionsNone
#endif
#ifndef NSXMLNodeExpandEmptyElement
  #define NSXMLNodeExpandEmptyElement CCXmlNodeExpandEmptyElement
#endif
#ifndef NSXMLNodeCompactEmptyElement
  #define NSXMLNodeCompactEmptyElement CCXmlNodeCompactEmptyElement
#endif
#ifndef NSXMLNodePrettyPrint
  #define NSXMLNodePrettyPrint CCXmlNodePrettyPrint
#endif
...
// CCXml has rather straight-forward memory management:
// https://github.com/wbitos/CCXml/wiki/MemoryManagementThreadSafety
// 
// There are 3 important concepts to keep in mind when working with CCXml:
// 
// 
// 1.) CCXml provides a light-weight wrapper around libxml.
// 
...
// CCXml provides an easy-to-use Objective-C library atop libxml.
// So a CCXmlNode, CCXmlElement, or CCXmlDocument are simply objective-c objects
...
// the library may create multiple CCXml wrapper objects that point to the same underlying xml node.
...
// </starbucks>
// 
// Imagine you have a CCXmlNode corresponding to the starbucks node,
// and you have a CCXmlNode corresponding to the latte node.
...
// So even though the CCXmlNode corresponding to the starbucks node may get deallocated,
// the underlying xml tree structure won't be freed until the latte node gets dealloacated.
// 
// In general, this means that CCXml remains thread-safe when reading and processing a tree.
...
// 
// 
// 3.) CCXml is read-access thread-safe, but write-access thread-unsafe (designed for speed).
// 
// <starbucks>
//   <latte/>
// </starbucks>
...
// And what if you still have a reference to the CCXmlNode that corresponds to the latte node?
...
// Thus the CCXml library is write-access thread-unsafe, but provides speedier performance.
// 
...
// 
// How does it work?
// Well everytime a CCXml wrapper object is created atop a libxml structure,
...
// So everytime a CCXml wrapper objects is about to dereference it's pointer,
...
#if DEBUG
  #define CCXml_DEBUG_MEMORY_ISSUES 0
#else
  #define CCXml_DEBUG_MEMORY_ISSUES 0 // Don't change me!
#endif
